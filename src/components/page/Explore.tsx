...
export default function Explore() {
  const serviceGrades = [
    ...
    {
      title: "Grade (6-8) Student",
      short: "Early Exploration",
      description: "Discover your strengths early and explore endless possibilities for a bright future!",
      path: "/programs/program1",
      icon: BookOpen,
      iconColor: "text-blue-600 bg-blue-50 border-blue-100",
    },
    {
      title: "Grade (9-10) Student",
      short: "Foundation Stream selection",
      description: "Build strong foundations today to unlock limitless career opportunities tomorrow!",
      path: "/programs/program2",
      icon: Sparkles,
      iconColor: "text-emerald-600 bg-emerald-50 border-emerald-100",
    },
    {
      title: "Grade (11-12) Student",
      short: "Advanced Career Tracks",
      description: "Shape your future wisely—every choice you make today paves the path to your dream career!",
    ...
    },
    {
      ...
      description: "Your degree is just the beginning—build skills, gain experience, and create the career you dream of!",
