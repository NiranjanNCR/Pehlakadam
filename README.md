...
- **💳 Streamlined UPI Checkout**: Instant 1-click UPI deep links (GPay, PhonePe, Paytm), dynamic QR codes with live discount recalculation, and fast 12-digit UTR reference entry.
- **🛡️ Single-Device Concurrency Control**: Restricts simultaneous active sessions to 1 device per phone number with automatic heartbeat verification.
